...
function Data() {
    ...
    return (
        <div className=" px-48  py-8 min-h-[100vh] border-[1px] border-blue-100 bg-[#0b0a0d]">
            ...
            <div className=" text-[18px] text-gray-100 p-3 bg-[#979bf0ac] h-[200px] my-6 rounded-md border-l-4 border-blue-100 ">
                <p className=" mb-2"><span className=" font-medium text-xl ">Exposed Code:</span> See the suspicious code's similarity score and Click <span className=" px-3 py-1 rounded-md bg-gray-400 font-bold">Code</span> to view a comparison.  This reveals the potentially leaked code and the user's submission side-by-side.  If you suspect cheating, click <span className=" px-3 rounded-md bg-red-500 font-bold py-1">Report</span> to flag the user directly on the contest platform.  Help us keep the playing field level by reporting confirmed cheaters.</p>
                <p className=" mb-2"><span className=" font-medium text-xl ">Search suspicious:</span>  Can't find someone you suspect? Don't worry, our hardware is constantly being upgraded to catch more cheaters.</p>
                <p><span className=" font-medium text-xl ">Request : </span>This app is still under beta testing, so there might be a few cases where code matches aren't perfect. Try searching for different users to see its effectiveness. We're constantly improving, so thanks for your patience!</p>
            </div>
            <div className=" px-4">
